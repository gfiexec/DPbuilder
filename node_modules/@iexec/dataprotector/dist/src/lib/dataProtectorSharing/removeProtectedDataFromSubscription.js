...
import { onlyProtectedDataIncludedInSubscription, onlyCollectionNotSubscribed, onlyCollectionOperator, } from './smartContract/preflightChecks.js';
import { getProtectedDataDetails } from './smartContract/sharingContract.reads.js';
export const removeProtectedDataFromSubscription = async ({ iexec = throwIfMissing(), sharingContractAddress = throwIfMissing(), protectedData, }) => {
    ...
    try {
        ...
        const tx = await sharingContract.removeProtectedDataFromSubscription(vProtectedData, txOptions);
        await tx.wait();
        return {
            txHash: tx.hash,
        };
...
//# sourceMappingURL=removeProtectedDataFromSubscription.js.map