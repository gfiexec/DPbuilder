...
import { onlyCollectionOperator, onlyProtectedDataCurrentlyForSale, } from './smartContract/preflightChecks.js';
import { getProtectedDataDetails } from './smartContract/sharingContract.reads.js';
export const removeProtectedDataForSale = async ({ iexec = throwIfMissing(), sharingContractAddress = throwIfMissing(), protectedData, }) => {
    ...
    try {
        ...
        const tx = await sharingContract.removeProtectedDataForSale(vProtectedData, txOptions);
        await tx.wait();
        return {
            txHash: tx.hash,
        };
...
//# sourceMappingURL=removeProtectedDataForSale.js.map