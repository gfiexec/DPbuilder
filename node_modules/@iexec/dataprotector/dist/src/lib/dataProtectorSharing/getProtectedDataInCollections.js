...
import { addressSchema, booleanSchema, numberBetweenSchema, positiveNumberSchema, throwIfMissing, } from '../../utils/validators.js';
import { getProtectedDataInCollectionsQuery } from './subgraph/getProtectedDataInCollectionsQuery.js';
export const getProtectedDataInCollections = async ({ graphQLClient = throwIfMissing(), protectedData, collectionId, collectionOwner, createdAfterTimestamp, isRentable, isForSale, isDistributed, page = 0, pageSize = 1000, }) => {
    ...
    try {
        const protectedDatasQueryResponse = await getProtectedDataInCollectionsQuery({
            graphQLClient,
        ...
        const protectedDataInCollection = protectedDatasQueryResponse.protectedDatas
            ...
            if (vIsDistributed) {
                return (oneProtectedData.isRentable ||
...
//# sourceMappingURL=getProtectedDataInCollections.js.map