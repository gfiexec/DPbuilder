...
import { addressOrEnsSchema, addressSchema, throwIfMissing, } from '../../utils/validators.js';
...
import { onlyAppNotInAppWhitelist, onlyAppOwnedBySharingContract, onlyAppWhitelistRegisteredAndManagedByOwner, } from './smartContract/preflightChecks.js';
export const addAppToAddOnlyAppWhitelist = async ({ iexec = throwIfMissing(), sharingContractAddress = throwIfMissing(), addOnlyAppWhitelist, app, }) => {
    ...
    const addOnlyAppWhitelistContract = await getAppWhitelistContract(iexec, vAddOnlyAppWhitelist);
    //---------- Smart Contract Call ----------
...
//# sourceMappingURL=addAppToAddOnlyAppWhitelist.js.map