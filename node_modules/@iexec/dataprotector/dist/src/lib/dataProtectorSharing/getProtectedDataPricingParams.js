...
export async function getProtectedDataPricingParams({ graphQLClient, protectedData, }) {
    const vProtectedData = addressOrEnsSchema()
        .required()
        .label('protectedData')
        .validateSync(protectedData);
    try {
        const { protectedData: oneProtectedData } = await getProtectedDataPricingParamsQuery({
            graphQLClient,
        ...
        const { id: address, name, isRentable, isIncludedInSubscription, isForSale, collection, rentalParam, } = oneProtectedData;
...
//# sourceMappingURL=getProtectedDataPricingParams.js.map