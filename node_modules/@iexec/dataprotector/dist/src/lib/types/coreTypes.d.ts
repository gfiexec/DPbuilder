import { Address, AddressOrENS, DataSchema, OnStatusUpdateFn, SearchableDataSchema } from './commonTypes.js';
/***************************************************************************
 *                        DataProtector Types                              *
 ***************************************************************************/
...
export type ProtectDataStatuses = 'EXTRACT_DATA_SCHEMA' | 'CREATE_ZIP_FILE' | 'CREATE_ENCRYPTION_KEY' | 'ENCRYPT_FILE' | 'UPLOAD_ENCRYPTED_FILE' | 'DEPLOY_PROTECTED_DATA' | 'PUSH_SECRET_TO_SMS' | 'PUSH_SECRET_TO_DEBUG_SMS';
...
export type GrantAccessStatuses = 'CREATE_DATASET_ORDER' | 'PUBLISH_DATASET_ORDER';
...
export type RevokeAllAccessStatuses = 'RETRIEVE_ALL_GRANTED_ACCESS' | 'REVOKE_ONE_ACCESS';
...
export type ProcessProtectedDataStatuses = 'FETCH_PROTECTED_DATA_ORDERBOOK' | 'FETCH_APP_ORDERBOOK' | 'FETCH_WORKERPOOL_ORDERBOOK' | 'PUSH_REQUESTER_SECRET' | 'REQUEST_TO_PROCESS_PROTECTED_DATA' | 'CONSUME_TASK' | 'CONSUME_RESULT_DOWNLOAD' | 'CONSUME_RESULT_DECRYPT';
