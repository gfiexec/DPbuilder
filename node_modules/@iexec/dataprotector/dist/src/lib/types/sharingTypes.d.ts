...
export type ConsumeProtectedDataStatuses = 'FETCH_WORKERPOOL_ORDERBOOK' | 'PUSH_ENCRYPTION_KEY' | 'CONSUME_ORDER_REQUESTED' | 'CONSUME_TASK' | 'CONSUME_RESULT_DOWNLOAD' | 'CONSUME_RESULT_DECRYPT' | 'CONSUME_RESULT_COMPLETE';
...
export type GetResultFromCompletedTaskStatuses = 'CONSUME_RESULT_DOWNLOAD' | 'CONSUME_RESULT_DECRYPT';
...
export type AddToCollectionStatuses = 'APPROVE_COLLECTION_CONTRACT' | 'ADD_PROTECTED_DATA_TO_COLLECTION';
