...
export type MimeType = 'application/octet-stream' | 'application/pdf' | 'application/xml' | 'application/zip' | 'audio/midi' | 'audio/mpeg' | 'audio/x-wav' | 'image/bmp' | 'image/gif' | 'image/jpeg' | 'image/png' | 'image/webp' | 'video/mp4' | 'video/mpeg' | 'video/x-msvideo';
...
export interface SearchableDataSchema extends Record<string, SearchableDataSchema | SearchableSchemaEntryType | SearchableSchemaEntryType[]> {
}
