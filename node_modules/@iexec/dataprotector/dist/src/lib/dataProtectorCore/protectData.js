...
export const protectData = async ({ iexec = throwIfMissing(), iexecDebug = throwIfMissing(), dataprotectorContractAddress, name = DEFAULT_DATA_NAME, ipfsNode, ipfsGateway, allowDebug = false, data, onStatusUpdate = () => { }, }) => {
