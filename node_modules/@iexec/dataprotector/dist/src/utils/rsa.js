...
export async function getFormattedKeyPair({ pemPublicKey, pemPrivateKey, }) {
...
export async function getOrGenerateKeyPair() {
    ...
    if (existingKeyPair) {
        ...
        const { publicKey: genPublicKey, privateKey: genPrivateKey } = await generateKeyPair();
