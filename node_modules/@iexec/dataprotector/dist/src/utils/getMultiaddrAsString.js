 ...
 */
export function getMultiaddrAsString({ multiaddrAsHexString, }) {
    ...
    try {
        ...
        console.warn(`[getMultiaddrAsString] ERROR: "${multiaddrAsHexString}" is not a valid hex input string?`, err);
        return undefined;
    }
}
//# sourceMappingURL=getMultiaddrAsString.js.map