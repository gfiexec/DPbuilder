...
export declare namespace IexecLibOrders_v5 {
    ...
    type AppOrderOperationStruct = {
        order: IexecLibOrders_v5.AppOrderStruct;
        operation: BigNumberish;
        sign: BytesLike;
    };
    type AppOrderOperationStructOutput = [
    ...
    type DatasetOrderOperationStruct = {
        order: IexecLibOrders_v5.DatasetOrderStruct;
        operation: BigNumberish;
        sign: BytesLike;
    };
    type DatasetOrderOperationStructOutput = [
    ...
    type RequestOrderOperationStruct = {
        order: IexecLibOrders_v5.RequestOrderStruct;
        operation: BigNumberish;
        sign: BytesLike;
    };
    type RequestOrderOperationStructOutput = [
    ...
    type WorkerpoolOrderOperationStruct = {
        order: IexecLibOrders_v5.WorkerpoolOrderStruct;
        operation: BigNumberish;
        sign: BytesLike;
    };
    type WorkerpoolOrderOperationStructOutput = [
...
export interface IExecPocoDelegateInterface extends Interface {
    getFunction(nameOrSignature: "allowance" | "approve" | "approveAndCall" | "balanceOf" | "deposit" | "manageAppOrder" | "manageDatasetOrder" | "manageRequestOrder" | "manageWorkerpoolOrder" | "matchOrders" | "transferFrom"): FunctionFragment;
    encodeFunctionData(functionFragment: "allowance", values: [AddressLike, AddressLike]): string;
    encodeFunctionData(functionFragment: "approve", values: [AddressLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "approveAndCall", values: [AddressLike, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "balanceOf", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "deposit", values?: undefined): string;
    encodeFunctionData(functionFragment: "manageAppOrder", values: [IexecLibOrders_v5.AppOrderOperationStruct]): string;
    encodeFunctionData(functionFragment: "manageDatasetOrder", values: [IexecLibOrders_v5.DatasetOrderOperationStruct]): string;
    encodeFunctionData(functionFragment: "manageRequestOrder", values: [IexecLibOrders_v5.RequestOrderOperationStruct]): string;
    encodeFunctionData(functionFragment: "manageWorkerpoolOrder", values: [IexecLibOrders_v5.WorkerpoolOrderOperationStruct]): string;
    ...
    decodeFunctionResult(functionFragment: "manageAppOrder", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "manageDatasetOrder", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "manageRequestOrder", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "manageWorkerpoolOrder", data: BytesLike): Result;
...
export interface IExecPocoDelegate extends BaseContract {
    ...
    getFunction(nameOrSignature: "approveAndCall"): TypedContractMethod<[
        spender: AddressLike,
        value: BigNumberish,
        extraData: BytesLike
    ], [
    ...
    getFunction(nameOrSignature: "manageAppOrder"): TypedContractMethod<[
        operation: IexecLibOrders_v5.AppOrderOperationStruct
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "manageDatasetOrder"): TypedContractMethod<[
        operation: IexecLibOrders_v5.DatasetOrderOperationStruct
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "manageRequestOrder"): TypedContractMethod<[
        operation: IexecLibOrders_v5.RequestOrderOperationStruct
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "manageWorkerpoolOrder"): TypedContractMethod<[
        operation: IexecLibOrders_v5.WorkerpoolOrderOperationStruct
    ], [
        void
    ], "nonpayable">;
