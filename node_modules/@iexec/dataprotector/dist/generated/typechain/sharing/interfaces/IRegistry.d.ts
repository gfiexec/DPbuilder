...
export interface IRegistryInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "getApproved" | "isApprovedForAll" | "isRegistered" | "ownerOf" | "safeTransferFrom"): FunctionFragment;
...
export interface IRegistry extends BaseContract {
    ...
    getFunction(nameOrSignature: "isRegistered"): TypedContractMethod<[_entry: AddressLike], [boolean], "view">;
